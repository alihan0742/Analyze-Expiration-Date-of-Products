...
f=imread('ürün.jpg'); % Reading the number plate image.
...
%else % If fail to extract the indexes in 'r' this line of error will be displayed.
   % fprintf('Unable to extract the characters from the number plate.\n');
    f%printf('The characters on the number plate might not be clear or touching with each other or boundries.\n');
%end
%end